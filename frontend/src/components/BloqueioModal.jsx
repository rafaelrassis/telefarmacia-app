...
const BloqueioModal = ({ onClose, onSaved }) => {
  ...
  return (
    ...
    >
      <div className="bg-canvas border border-line rounded-2xl shadow-md w-full max-w-md overflow-hidden">
        {/* Cabeçalho */}
        ...
        {conflitos && (
          <div className="mx-6 mt-4 bg-alert-wash border border-alert/30 rounded-xl p-4">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 border border-alert/40 text-alert text-xs font-semibold py-2 rounded-lg hover:bg-alert-wash transition"
              >
                Cancelar
              </button>
              <button
                ...
                disabled={saving}
                className="flex-1 bg-alert hover:opacity-90 disabled:opacity-50 text-alert-contrast text-xs font-bold py-2 rounded-lg transition"
              >
        ...
        {!conflitos && (
          <div className="px-6 py-5 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-line rounded-lg px-3 py-2 text-sm text-ink bg-canvas focus:ring-2 focus:ring-brand outline-none"
                />
              </div>
              {!diaInteiro && (
                <div>
            ...
            {erro && (
              <p className="text-xs text-error bg-error-wash border border-error/30 rounded-lg px-3 py-2">{erro}</p>
            )}
            ...
            <div className="flex gap-2 pt-1">
              ...
              <button
                ...
                disabled={saving}
                className="flex-1 bg-brand hover:bg-brand-deep disabled:opacity-50 text-brand-contrast text-sm font-bold py-2.5 rounded-xl transition"
              >
