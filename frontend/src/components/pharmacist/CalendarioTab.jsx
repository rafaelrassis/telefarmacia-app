  ...
  return (
    <div className="space-y-5">
      ...
      {stats && (
        <div className="grid grid-cols-3 gap-3">
          <div className="bg-canvas border border-line rounded-xl p-4 text-center">
            <p className="text-2xl font-bold text-brand-deep">{stats.emAtendimento}</p>
            <p className="text-xs text-muted mt-1">Em atendimento</p>
          </div>
          <div className="bg-canvas border border-line rounded-xl p-4 text-center">
            <p className="text-2xl font-bold text-brand">{stats.aceitas}</p>
      ...
      <div className="flex flex-wrap gap-3 text-xs">
        <span className="flex items-center gap-1.5"><span className="w-3 h-3 rounded bg-success-wash border border-success inline-block" />Agendada aceita</span>
        <span className="flex items-center gap-1.5"><span className="w-3 h-3 rounded bg-alert-wash border border-alert inline-block" />Urgente aceita</span>
        <span className="flex items-center gap-1.5"><span className="w-3 h-3 rounded bg-brand-wash border border-brand inline-block" />Em atendimento</span>
      </div>
