  ...
  return (
    <div className="space-y-4">
      <div className="bg-canvas border border-line rounded-2xl overflow-hidden">
        ...
        {msg && (
          <div className={`mx-5 mt-4 px-4 py-3 rounded-xl text-xs border ${msg.type === 'success' ? 'bg-success-wash border-success/20 text-success' : 'bg-error-wash border-error/20 text-error'}`}>
            {msg.text}
          </div>
        )}
                  ...
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                      ...
                      <button
                        ...
                        className="text-xs text-error hover:text-error/80 border border-error/20 hover:border-error/40 rounded-lg px-2.5 py-1 transition disabled:opacity-40"
                      >
