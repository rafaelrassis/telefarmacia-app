...
const DevolverAction = ({
  ...
  return (
    <>
      ...
      {canDevolver && !showDevolverConfirm && (
        <div className="flex">
          <button
            ...
            className="px-4 py-2 bg-canvas border border-alert/20 text-alert text-sm font-bold rounded-xl hover:bg-alert-wash disabled:opacity-50 transition"
          >
            ↩ Devolver para fila
          </button>
        </div>
      ...
      {showDevolverConfirm && (
        <div className="bg-alert-wash border border-alert/20 rounded-xl p-4 space-y-3">
          ...
          <textarea
            ...
            rows={2}
            className="w-full border border-alert/20 rounded-lg px-3 py-2 text-sm resize-none focus:ring-2 focus:ring-alert outline-none bg-canvas"
          />
          <div className="flex gap-2">
            ...
            <button
              ...
              className="flex-1 py-2 text-sm font-bold bg-alert text-white rounded-lg hover:opacity-90 disabled:opacity-50 transition"
            >
